...
@Component({
  ...
  template: `
    <div style="font-family:sans-serif;max-width:700px;margin:2rem;">
      ...
      <textarea [(ngModel)]="plain" rows="3" style="width:100%"></textarea
      ><br />
      ...
      <textarea [(ngModel)]="encrypted" rows="4" style="width:100%"></textarea
      ><br />
...
export class AesGCMComponent {
  ...
  backend = 'https://localhost:7153/api/AES_GCM';
  ...
  getKey(): void {
    this.http.get(this.backend + '/key', { responseType: 'text' }).subscribe({
      //debugger;
